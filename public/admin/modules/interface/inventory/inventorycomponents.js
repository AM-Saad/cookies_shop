...
function singleProduct(item) {
    ...
    $('#inventory-items').append(`
                ...
                <div class="inside-wrapper">
                    <div class="single-item_all_actions p-3 flex ">
                        <a class="edit-stock btn btn-alert single-item_actions">تعديل</a>
                        <a class="deleteitem btn btn-danger single-item_actions">حذف المنتج</a>
                    </div>
                    ...
                    <div class="grid g-two single-item_body">
                        <div class="single-item-core">
                            ...
                            <div class="info"><p>الكميه عند الانشاء: <b>${item.info.initialQuanitity}</b> قطعه</p></div>
                            <div class="info"><p>الكميه في المخزن: <b>${item.info.quantity}</b> قطعه</p></div>
                            <div class="info"><p>سعر الشراء/القطعه: <b>${item.info.purchasingPrice}</b>$</p></div>
                            <div class="info"><p>سعر البيع/القطعه: <b>${item.info.sellingPrice}<span class="c-g">$</span></b></p></div>
                            <div>
                                <div class="info"><p>الخصم: <b>${item.discount || '0'} %</b></p></div>
                                <div class="info"><p>وصف المنتج: <b>${item.description}</b></p></div>
                            </div>
                        </div>
                        <div class="single-item_advanced">
                            ...
                            <div class="item-category single-item_advanced_info">
                                ...
                                <div class="bg-lightgray p-3">
                                    <p>التنصيف: <b>${item.category.name}</b></p>
                                    <p class="${item.category.subCategory ? '' : 'none'}">التصنيف الفرعي: <b>${item.category.subCategory}</b></p>
    ...
    if (item.images.length > 0) {
        ...
        $('.images-perview.item-images').append(`<span class="c-g">اضف صور المنتج بحد اقصي 5 صور</span>`)
    }
